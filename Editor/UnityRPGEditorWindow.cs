...
namespace UnityRPGEditor.Editor
{
    ...
    public class CreateNewAsset
    {
        ...
        //get active folder path from unity editor. Normally a private function so we're using a relfection to call it anyway
        private string GetProjectWindowPath()
        {
            // using reflection to analyze a class, find a specific private function, and then call it
